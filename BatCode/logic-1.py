...
#  they like to have cigars. A squirrel party is successful when the number of cigars is
#   between 40 and 60, inclusive. Unless it is the weekend, in which case there is no upper 
#   bound on the number of cigars. Return true if the party with the given values is successful, 
#   or false otherwise.
def cigar_party(cigars, is_weekend):
  if is_weekend==True and cigars >= 40 or 40 <= cigars <= 60:
    return True
  else:
    return False
